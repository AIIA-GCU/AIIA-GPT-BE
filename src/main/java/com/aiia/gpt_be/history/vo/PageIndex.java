...
public class PageIndex {
    ...
    public PageIndex(Page pages, Pageable pageable, int blockLimit) {
        ...
        this.startPageNumber = getStartPageNumber(currentPageNumber, blockLimit);
        this.endPageNumber = getEndPageNumber(currentPageNumber, totalPageCount, blockLimit);
    }

    private int getStartPageNumber(int currentPageNumber, int blockLimit){
        if(doesInitialPage(currentPageNumber)) return 0;
